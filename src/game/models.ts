...
export interface Race { id:string; name:string; country:string; date:string; terrain:Terrain; distance:number; elevation:number; prestige:number; difficulty:number; maxAltitude?:number; weather?:WeatherConditions }
